...
// VITE_API_BASE_URL is read from the env at build time. for local dev set it to
// http://localhost:5000/api/v1 in your .env file. otherwise it points at the deployed api.
const API_BASE_URL = (import.meta.env.VITE_API_BASE_URL ?? 'https://vehicle-parts-api.onrender.com/api/v1').replace(/\/+$/, '');
